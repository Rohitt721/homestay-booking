                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold text-green-600">
                      {
                        bookings.filter(
                          (b: BookingType) => (b.status as string) === "CONFIRMED" || (b.status as string) === "confirmed"
                        ).length
                      }
                    </p>
                  </div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold text-yellow-600">
                      {
                        bookings.filter(
                          (b: BookingType) => (b.status as string) === "ID_PENDING" || (b.status as string) === "pending"
                        ).length
                      }
                    </p>
                  </div>
                          ...
                          <CardContent className="pt-0">
                            ...
                            {booking.status === "ID_PENDING" && (
                              <div className="mt-4 bg-amber-50 border border-amber-200 rounded-lg p-3 flex items-center gap-2">
                                ...
                                <p className="text-xs text-amber-800 font-medium">Waiting for guest to upload ID proof.</p>
                              </div>
                            )}
                            ...
                            {booking.status === "CONFIRMED" && (
                              <div className="mt-4 bg-green-50 border border-green-200 rounded-lg p-3 flex items-center gap-2">
                                ...
                                <p className="text-xs text-green-800 font-medium tracking-tight">ID Verified & Booking Confirmed</p>
                              </div>
                            )}
